Action()
{
	...
	lr_start_transaction("1_Main_NF");
...
RuleName ='process_uuid'*/
	...
	lr_end_transaction("1_Main_NF",LR_AUTO);


	lr_start_transaction("2_login_NF");
...
/*Correlation comment - Do not change!  Original value='1431766764' Name ='uid' Type ='ResponseBased'*/
	...
	lr_end_transaction("2_login_NF",LR_AUTO);

	

	lr_start_transaction("3_inPost_NF");
...
RuleName ='ckey":"(.*?)"'*/
	...
	lr_end_transaction("3_inPost_NF",LR_AUTO);

	

	lr_start_transaction("4_newFolder");
	...
	web_custom_request("liza1_16",
		...
		"Body={\"models\":[{\"name\":\"do-folders-add\",\"params\":{\"folder_name\":\"{lol}{ALLSECDATE}\"},\"meta\":{\"requestAttempt\":1}},{\"name\":\"folders\",\"params\":{},\"meta\":{\"requestAttempt\":1}}],\"_ckey\":\"{CorrelationParameter_2}\",\"_uid\":\"{uid}\",\"_locale\":\"ru\",\"_timestamp\":1642338743372,\"_product\":\"RUS\",\"_connection_id\":\"LIZA-{CorrelationParameter_1}\",\"_exp\":\"457741,0,-1;462916,0,79;451868,0,63;407772,0,43;404892,0,31;414430,0,2;406173,0,24;380961,0,91;428729,0,34;400316,0,16;475161,0,73;261659,0,32;118737,0,52;467180,0,23;406512,0,46;453153,0,50;443223,0,18;416833,0,81;456408,0,65;453083,0,38;403319,0,20;470107,0,99;286809,0,8;420030,0,61;300740,0,15;470118,0,82;317929,0,61;92934,0,82;416857,0,23;416853,0,6;383125,0,19;399880,0,7;358334,0,75;367504,0,64;402861,0,46;262911,0,86;381544,0,97;227595,0,55;343047,0,79\",\"_eexp\":\"457741,0,-1;462916,0,79;451868,0,63;404892,0,31;406173,0,24;380961,0,91;428729,0,34;475161,0,73;261659,0,32;118737,0,52;406512,0,46;456408,0,65;453083,0,38;286809,0,"
		"8;300740,0,15;470118,0,82;317929,0,61;416853,0,6;383125,0,19;399880,0,7;358334,0,75;367504,0,64;262911,0,86;381544,0,97;227595,0,55\",\"_service\":\"LIZA\",\"_version\":\"28.0.1\",\"_messages_per_page\":\"30\"}",
		LAST);

	lr_think_time(10);

	lr_end_transaction("4_newFolder",LR_AUTO);


	lr_start_transaction("5_logout_NF");
	...
	lr_end_transaction("5_logout_NF",LR_AUTO);
